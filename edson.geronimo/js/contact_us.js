...
$(".contact_btn").on('click', function () {
    ...
    else
    {
        if ($("#result").length) {
            // alert("yes");
            output = '<div class="alert-danger" style="padding:10px 15px; margin-bottom:30px;">Preencha corretamente!</div>';
            $("#result").hide().html(output).slideDown();
            $(".contact_btn i").addClass('d-none');
        }else{
            Swal.fire({
                ...
                type: 'error',
                title: 'Oops...',
                html: '<div class="text-danger">Preencha corretamente!</div>'
            })
            $(".contact_btn i").addClass('d-none');
        }
